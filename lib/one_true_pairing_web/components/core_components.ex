defmodule OneTruePairingWeb.CoreComponents do
  @moduledoc """
    ...
    <div class="overflow-y-auto px-4 sm:overflow-visible sm:px-0">
      <table class="w-[40rem] mt-11 sm:w-full">
        <thead class="text-sm text-left leading-6 text-zinc-500">
          <tr>
            <th :for={col <- @col} class="p-0 pr-6 pb-4 text-2xl text-black font-extrabold"><%= col[:label] %></th>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(OneTruePairingWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(OneTruePairingWeb.Gettext, "errors", msg, opts)
    end
  end
